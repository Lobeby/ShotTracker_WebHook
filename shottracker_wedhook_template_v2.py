...
urlWebHook = 'Your_Custom_WebHook_URL_like_https://discord.com/api/webhooks/XXX'
loginID = 'f.lastname'    # id ShotTracker
loginPW = 'xyz123'    # password ShotTracker
pfeID = XX    # This is the hardest to get
